...
<img src="final/img_readme/1.png" width="80%" height="380">
<img src="final/img_readme/2.png" width="80%" height="380">
<p>When you click to the sub-navigator <a href="https://health-safety.herokuapp.com/">HEALTH and SAFETY</a> there will appeare the home page of an app</p>
<img src="final/img_readme/3.png" width="80%" height="380">
<img src="final/img_readme/4.png" width="80%" height="380">
<img src="final/img_readme/5.png" width="80%" height="380">
...
<p><h4><b><a href="https://health-safety.herokuapp.com/"> - HOME</a></b></h4></p>
<p>HOME page is the MAIN page of the web site. It looks the same with the MAIN page.</p>
<p><h4><b><a href="https://health-safety.herokuapp.com/face-masks"> - FACE MASKS,</a><a href="https://health-safety.herokuapp.com/physical-distancing"> PHYSICAL DISTANCING,</a><a href="https://health-safety.herokuapp.com/hand-hygiene"> HAND HYGIENE,</a><a href="https://health-safety.herokuapp.com/testing"> TESTING,</a><a href=""></a></b></h4></p>
<p>This 4 pages have the same skelaton and do the same function. They all have the same header and the same navigator at the top of the windows.</p><p> After them there is located a video,paragraphs that give informations about that special section which is different in every part: (Face Masks, Physical Distancing, Hand Hygiene, Testing, Daily Health Check). Every single paragraph gives some useful information, that releases the risk of get infected with covid-19, if you follow them.</p><p>After paragraphs there is located links as in MAIN page of an app, which makes to reach other sections and saves your time.</p>At the bottom of the pages located the footer.</p><p>Here is a screenshot of a section <a href="https://health-safety.herokuapp.com/face-masks">FACE MASKS</a> as an example to all this:</p>
<img src="final/img_readme/6.png" width="80%" height="380">
<img src="final/img_readme/7.png" width="80%" height="380">
<p><h4><b><a href="https://health-safety.herokuapp.com/daily-health-check"> - DAILY HEALTH CHECK</a></b></h4></p>
...
<img src="final/img_readme/8.png" width="80%" height="380">
<p>Then, you should fill that questionnaire.</p>
<img src="final/img_readme/9.png" width="80%" height="380">
<p>You will receive a GREEN, YELLOW, or RED pass,according to your answers. </p>
<p><b>GREEN:</b></p>
...
<img src="final/img_readme/11.png" width="80%" height="380">
<p><b>YELLOW:</b></p>
<p>Those who exhibit secondary symptoms (e.g., unexplained new sore throat, headache, body aches, etc.)</p>
<img src="final/img_readme/10.png" width="80%" height="380">
<p><b>RED:</b></p>
...
<img src="final/img_readme/12.png" width="80%" height="380">
